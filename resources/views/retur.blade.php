...
@section('content')
    ...
    <div class="col-lg-10">
        <div class="card">
            <div class="card-body">
                <!-- MULAI TOMBOL TAMBAH -->
                <a href="javascript:void(0)" class="btn btn-info" id="tombol-tambah">Tambah Retur</a>
                <br><br>
                <!-- AKHIR TOMBOL -->
                <!-- MULAI TABLE -->
...
@section('script')
    ...
    <script>
        ...
        $('#tombol-tambah').click(function() {
            ...
            $('#modal-judul').html("Tambah returs Baru"); //valuenya tambah returs baru
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('returs.store') }}", //url simpan data
                        ...
                        success: function(data) { //jika berhasil 
                            ...
                            var oTable = $('#table_retur').dataTable(); //inialisasi datatable
        ...
        //TOMBOL EDIT DATA PER returs DAN TAMPIKAN DATA BERDASARKAN ID returs KE MODAL
        //ketika class edit-post yang ada pada tag body di klik maka
        $('body').on('click', '.edit-post', function() {
            var data_id = $(this).data('id');
            $.get('returs/' + data_id + '/edit', function(data) {
        ...
        $('#tombol-hapus').click(function() {
            $.ajax({
                url: "returs/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function() {
                ...
                success: function(data) { //jika sukses
                    setTimeout(function() {
                        ...
                        var oTable = $('#table_retur').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
