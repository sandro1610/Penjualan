        ...
        ***********************************-->
        <div class="nav-header">
            <a href="" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('images/Indomarco.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('images/Indomarco.png') }}" alt="">
                <img class="brand-title" src="{{ asset('images/indomarco1.png') }}" alt="">
            </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="/penjualans" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-network"></i>
                            <span class="nav-text">Penjualan</span>
                        </a>
                    </li>
                    <li><a href="/produks" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Produk</span>
                        </a>
                    </li>
                    <li><a href="/returs" class="ai-icon" aria-expanded="false">
